        ...
        function (data) {
            ...
            if ('success' in data && data.success) {
                ...
                if (levelNumber === lastLevel) {
                    $messageDisplayBox.html('<div class="message bigMessage"> <h2>Congratulations!!</h2> <h3>You finished the game!</h3> ' +
                        '<h3>You completed it in a time of: <!-- --></h3> <h3>It took you a total of <!-- --> attempts!</h3> ' +
                        '<h3>Your results have been submitted, to play again click Restart!</h3> ' +
                        '<input type="button" value="Restart" class="loadLevel messageButton"> ' +
                        '<input type="button" value="Quit Game" class="quit messageButton"></div>')
                } else {
...
function gameDeath() {
    ...
    $messageDisplayBox.html("<div id='endOfGame' class='popBig'><span class='bigTitle'>Congratulations!!</span><br><br><span class='bigSubtitle'>You finished the game!</span><br><br><div>Your time: ")
